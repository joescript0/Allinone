...
@section('name', 'ROLES UTILISATEURS')
@section('body')
...
<section class="content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="btn-primary btn-sm" id="liste" href="">
                                    <i class="zmdi zmdi-settings"></i> Liste
                                </a>
                                &nbsp;
                                <a class="btn-primary btn-sm" id="add" href="">
                                    <i class="zmdi zmdi-settings-square"></i> Ajouter
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div style="margin-top: 30px;" class="container">
        <div class="row">
            <div class="col-lg-12">
                <h6 style="color:rgba(0, 0, 0, 0.6);">{{ strtoupper(Auth::user()->name) }}&nbsp; <i class="zmdi zmdi-chevron-right"></i> &nbsp; Rôles utilisateurs</h6>
            </div>
            <div id="bloc_1" style="margin-top: 12px;" class="col-lg-12">
                <h4 style="color:rgba(0, 0, 0, 0.6);"><i style="font-size: 40px;" class="zmdi zmdi-settings text-info"></i> Listes</h4>
            ...
            <div id="bloc_2" style="margin-top: 12px;display: none;" class="col-lg-12">
                <h4 style="color:rgba(0, 0, 0, 0.6);"><i style="font-size: 40px;" class="zmdi zmdi-settings-square text-info"></i> Ajouter</h4>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="nom" name="nom" style="font-weight: bold;border-radius:5px;padding-left: 5px;border: 1px solid rgba(0, 0, 0, 0.2);" class="form-control" placeholder="Nom (Ex : Admin)">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    $("#link_11").css("border-left", "1px solid rgb(33, 150, 243)");
    $("#text_11").addClass("text-info");
    $("#icone_11").css("color", "rgb(33, 150, 243)");
        ...
        if (nom.trim().length == 0) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        $('#msg').html('<i class="zmdi zmdi-close-circle"></i> Ce rôle existe déjà');
                        $('#msg').css('color', "#ff6b68");
                        setTimeout(() => {
                            $('#msg').html("");
                        }, 9000);
