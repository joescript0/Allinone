...
@section('name', 'TYPE DE DOCUMENTS')
@section('body')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h6 style="color:rgba(0, 0, 0, 0.6);">{{ strtoupper(Auth::user()->name) }}&nbsp; <i
                            class="zmdi zmdi-chevron-right"></i> &nbsp; Types de documents</h6>
                </div>
                                                ...
                                                <td style="text-align: center;padding-top: 5px;padding-bottom: 5px;">
                                                    ...
                                                    <script>
                                                        $("#edit_<?= $i ?>").click(function(e) {
                                                            e.preventDefault();
                                                            $.get("{{ url('/refresh_edit_type_documents') }}", {
                                                                type_documents_id: <?= $data->id ?>,
                ...
                <div id="bloc_2" style="margin-top: 12px;display: none;" class="col-lg-12">
                    <h4 style="color:rgba(0, 0, 0, 0.6);"><i style="font-size: 40px;"
                            class="zmdi zmdi-money-box text-info"></i> Ajouter</h4>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nom" name="nom"
                                        ...
                                        class="form-control" placeholder="Nom (Ex : Rapport)">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
...
@section('js-code')
    ...
    <script>
        ...
        $("#icone_28").css("color", "rgb(33, 150, 243)");
        ...
        $("#save").click(function(e) {
            ...
            if (nom.trim().length == 0) {
                $('#msg').html('<i class="zmdi zmdi-close-circle"></i> Completez le nom du type de document');
                ...
                $.ajax({
                    type: "POST",
                    url: "/check_type_documents",
                    data: data,
                    success: function(response) {
                        if (response == 1) {
                            $('#msg').html(
                                '<i class="zmdi zmdi-close-circle"></i> Ce type de document existe déjà'
                                );
                            $('#msg').css('color', "#ff6b68");
                            setTimeout(() => {
                                $('#msg').html("");
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $("#description").val("");
                                    $('#msg').html(
                                        '<i class="zmdi zmdi-check-circle"></i> Type de document ajouté avec succès'
                                        );
        ...
        $("#oui").click(function(e) {
            e.preventDefault();
            var id = $("#data_id").html();
            $.get("{{ url('/refresh_delete_type_documents') }}", {
                id: id,
