...
@section('body')
    ...
    <style>
        /* =============================================
           DESIGN PREMIUM - VERSION FINALE (copié depuis Gestion Article)
        ...
        /* ========== BOUTONS PRINCIPAUX (Liste, Ajouter, Importer, Exporter) ========== */
        #liste,
        #add,
        #print,
        #add_r,
        ...
        .filter-group input[type="text"].input-mask {
            height: 42px;
        }
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    &nbsp;
                                    <!-- Boutons Importer et Exporter avec leurs IDs et classes -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0" id="depensesTable">
                                    ...
                                    <tbody id="depensesTableBody">
                                        ...
                                        <tr data-libelle="{{ $data->type_depense_id ? (Type_frais::find($data->type_depense_id)->nom ?? '') : ($data->libelle ?? '') }}">
                                            ...
                                            <script>
                                                $("#edit_<?= $i ?>").click(function(e) {
                                                    ...
                                                    if (type == "powerpoint") { console.log("Powerpoint"); }
                                                    if (type == "audio") { console.log("audio"); }
                                                    if (type == "vidéo") { console.log("vidéo"); }
                                                });
                                            </script>
                                        </tr>
                                            {{ !$i++ }}
    ...
    <!-- ========== MODALES IMPORT / EXPORT AJOUTÉES ========== -->
        ...
        $(document).ready(function() {
            ...
            function loadFilters() {
                ...
                try {
                    ...
                    if (filters.filterDateRange !== undefined) $('#filterDateRange').val(filters.filterDateRange);
            ...
            // =================================================================
            // 6. CHARGEMENT DES FILTRES PERSISTANTS
            // =================================================================
            loadFilters();
            filterDepenses();

            // =================================================================
            // 7. GESTION DES MODALES IMPORT / EXPORT (AJOUTÉ)
            // =================================================================
            ...
            $("#confirmImportBtn").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        location.reload(); // ou mettre à jour le tableau via AJAX
            ...
            $("#exportPdfBtn").click(function(e) {
                ...
                // Récupérer les filtres pour les passer en paramètres
                var filters = {
                    _token: '{{ csrf_token() }}',
                    user: $('#filterUser').val(),
            ...
            // =================================================================
            // 8. AUTRES SCRIPTS EXISTANTS (conservés)
            // =================================================================
            $("#link_36").css("border-left", "1px solid rgb(33, 150, 243)");
            $("#text_36").addClass("text-info");
