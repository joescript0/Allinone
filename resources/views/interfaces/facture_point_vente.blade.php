...
/* ============================================================
   MODALE PARAMÈTRES FACTURE – STYLES COMPLETS (AJOUT)
   ============================================================ */
...
@media (max-width: 768px) {
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($factures as $data)
                                            @php
                                                ...
                                                /* ===== AJOUT : données pour la modale Paramètres ===== */
                                                if ($reste_usd <= 0) {
                                                    $statut_code = 'paid';
                                                ...
                                                // Construction du JSON paiements
                                                $paiements_json = [];
                                            ...
                                            <tr id="row_{{ $data->id }}"
                                                ...
                                                <!-- ========== CORRECTIF : data-statut gère 3 états (paid / partiel / unpaid) ========== -->
    ...
    {{-- ========== AJOUT : MODALE PARAMÈTRES FACTURE ========== --}}
...
@section('js-code')
    ...
    <script>
        ...
        // ============================================================
        // HELPERS POUR LA MODALE PARAMÈTRES (AJOUT)
        // ============================================================
        ...
        $(document).ready(function() {
            ...
            // ============================================================
            // AJOUT : MODALE PARAMÈTRES FACTURE – OUVERTURE (DOM)
            // ============================================================
            ...
            // ============================================================
            // AJOUT : SAUVEGARDE DES LIGNES (FRAIS CRÉDIT + RÉDUCTION)
            // ============================================================
