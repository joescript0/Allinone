...
<section class="content">
    ...
    <div style="margin-top: 30px;" class="container">
        <div class="row">
            <div class="col-lg-12">
                <h6 style="color:rgba(0, 0, 0, 0.6);">{{ strtoupper(Auth::user()->name) }}&nbsp; <i class="zmdi zmdi-chevron-right"></i> &nbsp; Verbalisateurs</h6>
            </div>
...
<script>
    $("#link_13").css("border-left", "1px solid rgb(33, 150, 243)");
    $("#text_13").addClass("text-info");
    $("#icone_13").css("color", "rgb(33, 150, 243)");
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/add_verbalisateur",
                            data: data,
                            success: function(response) {
                                $("#save").attr("disabled", false);
                                $("#nom").val("");
                                $('#msg').html('<i class="zmdi zmdi-check-circle"></i> Verbalisateur ajouté avec succès');
    ...
    $("#oui").click(function(e) {
        e.preventDefault();
        var id = $("#data_id").html();
        $.get("{{ url('/refresh_deleteverbalisateur') }}", {
            id: id,
        }, function(refresh_editverbalisateur) {
