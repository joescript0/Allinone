...
.table tbody td a i.zmdi-money.text-info {
    color: #3b82f6 !important;
}
.table tbody td a i.zmdi-print.text-dark {
...
.table tbody td a:hover i.zmdi-money.text-info {
    color: #2563eb !important;
}
.table tbody td a:hover i.zmdi-print.text-dark {
...
/* ========== MESSAGE AUCUN RÉSULTAT (si utilisé) ========== */
#noResultRow td {
    text-align: center;
