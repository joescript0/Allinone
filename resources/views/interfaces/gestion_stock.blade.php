...
@section('body')
    ...
    <style>
/* ============================================================
   DESIGN PREMIUM – UNIFIÉ (GESTION DE STOCK)
   ============================================================ */
...
.table tbody td a i.zmdi-storage {
    color: #475569;
}
.table tbody td a i.zmdi-settings {
    color: #3b82f6;
}
/* Version désactivée (text-secondary) pour la ligne Stock principal */
.table tbody td a i.zmdi-edit.text-secondary {
    color: #94a3b8 !important;
}
.table tbody td a i.zmdi-delete.text-secondary {
    color: #94a3b8 !important;
}
...
.table tbody td a:hover i.zmdi-storage {
    color: #1e293b;
}
.table tbody td a:hover i.zmdi-settings {
    color: #2563eb;
}
/* Pas de survol pour les liens désactivés (Stock principal) */
.table tbody td a:has(i.zmdi-edit.text-secondary):hover,
.table tbody td a:has(i.zmdi-delete.text-secondary):hover {
    background: #f1f5f9;
    transform: none;
}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h6 style="color:rgba(0, 0, 0, 0.6);">{{ strtoupper(Auth::user()->name) }}&nbsp; <i
                            class="zmdi zmdi-chevron-right"></i> &nbsp; Gestion de stock</h6>
                </div>
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;padding-top: 5px;padding-bottom: 5px;">
                                                <a id="edit_1" href="#"><i
                                                        class="zmdi zmdi-edit text-secondary"></i></a> &nbsp;
                                                <a id="article_1" href="#"><i
                                                        class="zmdi zmdi-storage text-dark"></i></a> &nbsp;
                                                <a id="affectation_1" href="#"><i class="zmdi zmdi-settings text-info"></i></a> &nbsp;

                                                <a id="delete_1" href="#"><i
                                                        class="zmdi zmdi-delete text-secondary"></i>
                                                </a>
                                            </td>
                                            <script>
                                        ...
                                        @foreach ($stocks as $data)
                                            <tr>
                                                ...
                                                <td style="text-align: center;padding-top: 5px;padding-bottom: 5px;">
                                                    ...
                                                    <a id="article_<?= $i ?>" href="#"><i
                                                            class="zmdi zmdi-storage text-dark"></i></a> &nbsp;
                                                    <a id="affectation_<?= $i ?>" href="#"><i class="zmdi zmdi-settings text-info"></i></a> &nbsp;
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nom" name="nom"
                                        ...
                                        class="form-control" placeholder="Nom (Ex : Stock 1)">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                        ...
                        if (response == 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    $("#description").val("");
                                    $('#msg').html(
                                        '<i class="zmdi zmdi-check-circle"></i> Stock ajouté avec succès'
                                        );
