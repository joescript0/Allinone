...
@section('body')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h6 style="color:rgba(0, 0, 0, 0.6);">{{ strtoupper(Auth::user()->name) }}&nbsp; <i
                            class="zmdi zmdi-chevron-right"></i> &nbsp; Alerte mobile</h6>
                </div>
    ...
    <span id="alerte_active" style="display: none;" style="">{{ Alertes::where(['supprimer' => 0, 'etat_2' => 1])->where('user_id_transfert', '!=', 0)->get()->count(); }}</span>
...
@section('js-code')
    ...
    $(document).ready(function() {
        ...
        setInterval(function() {
            ...
            $.get("{{ url('/count_alerte_etat_2') }}", {}, function(nombre_alerte_etat_1) {
                if (nombre_alerte_etat_1 != alerte_active) {
                    ...
                    $.get("{{ url('/refresh_alerte_centrale_1') }}", {}, function(refresh_alerte_centrale) {
    ...
    $("#link_34").css("border-left", "1px solid rgb(33, 150, 243)");
    $("#text_34").addClass("text-info");
    $("#icone_34").css("color", "rgb(33, 150, 243)");
