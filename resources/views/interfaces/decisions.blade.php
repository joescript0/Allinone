                            ...
                            <div class="col-12" style="display: flex; flex-wrap: wrap; gap: 12px; align-items: center;">
                                ...
                                <?php if ((Writes::where(["ressource_id" => $ressource_id_1, "groupe_id" => $groupe_user_id])->get()->count() != 0) || (Auth::user()->role == 0)) { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        &nbsp;
                                        <a id="print_r" class="btn-secondary btn-sm" href="" style="background: #cbd5e1 !important; color: #475569 !important; cursor: not-allowed; opacity: 0.7;">
                                            <i class="zmdi zmdi-print"></i> Imprimer
                                        </a>
                                    <?php } ?>
                                <?php } ?>
            ...
            <div id="bloc_1" style="margin-top: 12px;" class="col-lg-12">
                <h4 style="color:rgba(0, 0, 0, 0.6);">
                    ...
                    <span class="project-count-badge">
                        <i class="zmdi zmdi-view-list"></i> <span id="projectCount">0</span>
                    </span>
                </h4>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody id="projectsTableBody">
                                    ...
                                    <tr id="noResultRow" style="display: none;">
                                        <td colspan="6">
                                            <i class="zmdi zmdi-info-outline"></i> Aucun projet ne correspond à vos critères.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<script>
    $(document).ready(function() {
        ...
        function filterProjects() {
            ...
            $('#projectsTableBody tr:not(#noResultRow)').each(function() {
                const $row = $(this);
        ...
        $("#save").click(function(e) {
            ...
            } else if (fin.split("/")[2] +'-'+ fin.split("/")[1] + "-" + fin.split("/")[0] <= debut.split("/")[2] +'-'+ debut.split("/")[1] + "-" + debut.split("/")[0]) {
        ...
        // Impression (à conserver)
        $("#print").click(function(e) {
            e.preventDefault();
            // Action d'impression (existante)
        });
