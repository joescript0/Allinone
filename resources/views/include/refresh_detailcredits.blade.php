                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        $.get("{{ url('/check_remboursement') }}",
                        {
                            ...
                            var r = remboursement.split("__________");
                            $("#save_r").attr("disabled", false);
                            if(r[0] == 0)
                            {
                                $('#msg_r').html('<i class="zmdi zmdi-close-circle"></i> Remboursement deja terminé');
                                $('#msg_r').css('color', "#ff6b68");
                                setTimeout(() => {
                                    $('#msg_r').html("");
                                }, 9000);
                            ...
                            {
                                $("#entree_r").val(0);
                                $('#msg_r').html('<i class="zmdi zmdi-check-circle"></i> Remboursement effectué avec succès');
                                $('#msg_r').css("color", '#32c787');
                                $.get("{{ url('/refresh_detailcredits_2') }}", {
                            ...
                            if(r[0] == 2)
                            {
                                $('#msg_r').html('<i class="zmdi zmdi-close-circle"></i> Vous pouvez remboursement au moins que : ' + r[1] + "$");
                                $('#msg_r').css('color', "#ff6b68");
                                setTimeout(() => {
                                    $('#msg_r').html("");
                                }, 9000);
