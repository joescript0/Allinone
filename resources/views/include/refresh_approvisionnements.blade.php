...
?>
<div class="col-12">
    <h4 style="text-align: center;color: white;background-color: rgb(0, 0, 0);padding: 15px;">DETAIL FACTURE
        APPROVISIONNEMENT : {{ strtoupper($numero) }}</h4>
</div>
<div class="col-12">
    <h6 style="text-align: right;font-weight: bold;">
        <span>
            @if ($devise == 0)
                <span> <i class="zmdi zmdi-check-circle text-success"></i>
