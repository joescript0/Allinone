...
<form id="form_edit" action="#" method="post">
    ...
    <div style="display: none;" class="col-6">
            <div class="form-group">
                ...
                <input type="text" id="id" name="id" style="font-weight: bold;border-radius:5px;padding-left: 5px;border: 1px solid rgba(0, 0, 0, 0.2);" class="form-control" placeholder="Nom (Ex : Mgm congo)" value="<?= $contrevenants->id ?>">
            </div>
        </div>
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" id="edit_nom" name="edit_nom" style="font-weight: bold;border-radius:5px;padding-left: 5px;border: 1px solid rgba(0, 0, 0, 0.2);" class="form-control" placeholder="Nom (Ex : Admin)" value="<?= $contrevenants->nom ?>">
            </div>
        </div>
    </div>
    <div class="row">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/edit_contrevenant",
                            data: data,
                            success: function(response) {
                                $("#edit_save").attr("disabled", false);
                                $('#edit_msg').html('<i class="zmdi zmdi-check-circle"></i> contrevenant modifié avec succès');
