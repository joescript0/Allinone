        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input id="edit_prix_detail" name="edit_prix_detail" type="text" class="form-control input-mask"
                    ...
                    style="font-weight: bold;padding-left: 5px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);"
                    placeholder="Prix de détail (Ex : 10)" value="<?= $articles->prix_detail ?>">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                ...
                <input id="edit_prix_gros" name="edit_prix_gros" type="text" class="form-control input-mask"
                    data-mask="00000000000000000000000000000000000000"
                    style="font-weight: bold;padding-left: 5px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);"
                    placeholder="Prix de gros (Ex : 10)" value="<?= $articles->prix_gros ?>">
            </div>
        </div>
    </div>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input id="edit_taille_lot" name="edit_taille_lot" type="text" class="form-control input-mask"
                    data-mask="00000000000000000000000000000000000000"
                    style="font-weight: bold;padding-left: 5px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);"
                    placeholder="Taille du lot (Ex : 10)" value="<?= $articles->taille_lot ?>">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select id="edit_avoir_stock" name="edit_avoir_stock" class="form-control"
                    ...
                    @if ($articles->avoir_stock == 1)
                        <option selected class="form-control" value="1">Déterminé</option>
                        <option class="form-control" value="0">Indeterminé</option>
                    @else
                        <option class="form-control" value="1">Déterminé</option>
                        <option selected class="form-control" value="0">Indeterminé</option>
                    @endif
                </select>
            </div>
        </div>
