...
<div class="col-12">
    ...
    <h6 style="text-align: right;font-weight: bold;"><span><span> <i class="zmdi zmdi-check-circle text-success"></i> Total : <span id="total_1"><?= round($t, 2) ?></span>$</span></h6>
    <div class="table-responsive">
        <table class="table table-bordered mb-0">
            <thead>
                <tr>
                    <th style="padding-top: 5px;padding-bottom: 5px;">Type de sortie</th>
