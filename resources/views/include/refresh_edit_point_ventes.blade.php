    ...
    <div style="display: none;" class="col-6">
        <div class="form-group">
            ...
            <input type="text" id="id" name="id"
                ...
                class="form-control" placeholder="Nom (Ex : Mgm congo)" value="<?= $point_ventes->id ?>">
        </div>
    </div>
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="text" id="edit_nom" name="edit_nom"
                    style="font-weight: bold;border-radius:5px;padding-left: 5px;border: 1px solid rgba(0, 0, 0, 0.2);"
                    class="form-control" placeholder="Libelle (Ex : MGM)" value="<?= $point_ventes->nom ?>">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                ...
                <textarea style="font-weight: bold;border-radius:5px;padding-left: 5px;border: 1px solid rgba(0, 0, 0, 0.2);"
                    ...
                    rows="1"><?= $point_ventes->description ?></textarea>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    if (response == 1) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $("#description").val("");
                                $('#edit_msg').html(
                                    '<i class="zmdi zmdi-check-circle"></i> Point de vente modifié avec succès'
                                    );
